...
urlpatterns = patterns('board.api.resources',
    ...
    (r'^thread/(?P<section>\w+)$', 'ThreadResource'),
    (r'^thread/(?P<section>\w+)/(?P<page>\d+)$', 'ThreadResource'),
    (r'^thread/(?P<section>\w+)/(?P<op_post>\d+)$', 'ThreadResource'),
    ...
    (r'^filecategory/$', 'FileCategoryRootResource'),
    (r'^filecategory/(?P<id>\d+)$', 'FileCategoryResource'),
)
